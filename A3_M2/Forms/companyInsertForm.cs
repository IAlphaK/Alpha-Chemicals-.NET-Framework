...
{
    public partial class companyInsertForm : Form
    {
        string username;
        public companyInsertForm(string username)
        {
            InitializeComponent();
        ...
        private bool InsertData()
        {
            try
            {
                ...
                if (company.InsertCompany(int.Parse(insFarmerID.Text), insName.Text, insAddress.Text, insContact.Text, balance))
                {
